...
class Database
{
    ...
    private function readRecordsWithLock(string $filePath, &$lockHandle): ?array
    {
        ...
        // Reads must use a shared lock so concurrent dashboard/API reads do not block one another.
        // Mutating operations still upgrade through writeRecordsWithLock() while holding the handle.
    ...
    {
        // Upgrade lock handle to exclusive lock before mutating
