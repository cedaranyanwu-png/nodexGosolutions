...
// Calculate exact start date for the free trial (current timestamp)
$trialStart = date('Y-m-d H:i:s');
// Automatically calculate trial expiration date set exactly to 1 month later
$trialEnd = date('Y-m-d H:i:s', strtotime('+1 month'));

// Save user structure with auto-provisioned trial fields to database table
$newUser = $conn->insert('users', [
    ...
    // Start of the free trial period (current time)
    'trial_start'        => $trialStart,
    // Precise expiration date of the free trial
    'trial_end'          => $trialEnd,
    // Initial subscription status defaults to 'trial'
    'subscription_status'=> 'trial',
    // Assign starter subscription plan to user workspace
    'subscription_plan'  => 'Starter Space',
    // Set paid subscription start to null until actual payment is made
    'subscription_start' => null,
    // Set paid subscription expiration to null until actual payment is made
