...
(function() {
    ...
    const trackEvent = function(eventName) {
        const payloadUrl = '/php/track_metrics.php?subdomain=" . htmlspecialchars($websiteSubdomain) . "&event=' + eventName;
    ...
    // Track standard page load
    trackEvent('page_view');

    // Track click interaction on clickBtn
