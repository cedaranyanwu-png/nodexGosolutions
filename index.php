...
// Canonical single-entry tenant routing: /site/{subdomain}/... resolves to public/{subdomain}/...
$tenantRouteSubdomain = null;
$tenantRoutePath = $requestUri;
if (preg_match('#^/site/([^/]+)(/.*)?$#', $requestUri, $tenantRouteMatch)) {
    $tenantRouteSubdomain = strtolower(rawurldecode($tenantRouteMatch[1]));
    $tenantRoutePath = $tenantRouteMatch[2] ?? '/';
    if (!isset($tenantRouteMatch[2]) || $tenantRouteMatch[2] === '') {
        header('Location: /site/' . rawurlencode($tenantRouteSubdomain) . '/');
        exit;
    }
}
...
if ($requestUri === '/profile' || $requestUri === '/profile.php' || $requestUri === '/analytics' || $requestUri === '/analytics.php') {
    ...
    if (str_contains($requestUri, 'profile')) {
        $target = $isAdminContext ? '/admin/profile' : '/user/dashboard#profile';
    } else {
...
$routeMap = [
    ...
    '/admin/files' => __DIR__ . '/main/public/admin/files.php',
    '/admin/websites.php' => __DIR__ . '/main/public/admin/websites.php',
    '/admin/pages' => __DIR__ . '/main/public/admin/pages.php',
    '/admin/pages.php' => __DIR__ . '/main/public/admin/pages.php',
    ...
    // Legacy role URLs now resolve to the unified admin dashboard instead of missing files.
    '/admin/manager' => __DIR__ . '/main/public/admin/dashboard.php',
    '/admin/manager.php' => __DIR__ . '/main/public/admin/dashboard.php',
    '/admin/financial' => __DIR__ . '/main/public/admin/dashboard.php',
    '/admin/financial.php' => __DIR__ . '/main/public/admin/dashboard.php',
    ...
    '/admin/profile' => __DIR__ . '/main/public/admin/profile.php',
    '/admin/profile.php' => __DIR__ . '/main/public/admin/profile.php',
    '/editor' => __DIR__ . '/main/public/editor.php',
    '/editor.php' => __DIR__ . '/main/public/editor.php',
    ...
    '/user/subscriptions' => __DIR__ . '/main/public/user/tabs/subscriptions.php',
    ...
    '/api/auth/status' => __DIR__ . '/api/auth/status.php',
    '/api/websites/create' => __DIR__ . '/api/websites/create.php',
    '/api/websites/list' => __DIR__ . '/api/websites/list.php',
    '/api/websites/delete' => __DIR__ . '/api/websites/delete.php',
    '/api/subscriptions/current' => __DIR__ . '/api/subscriptions/current.php',
    '/api/subscriptions/plans' => __DIR__ . '/api/subscriptions/plans.php',
    '/api/payments/initialize' => __DIR__ . '/api/payments/initialize.php',
    '/api/payments/verify' => __DIR__ . '/api/payments/verify.php',
    '/api/payments/history' => __DIR__ . '/api/payments/history.php',
    '/api/domains/connect' => __DIR__ . '/api/domains/connect.php',
    '/api/domains/remove' => __DIR__ . '/api/domains/remove.php',
    '/api/files/list' => __DIR__ . '/api/files/list.php',
    '/api/files/read' => __DIR__ . '/api/files/read.php',
    '/api/files/save' => __DIR__ . '/api/files/save.php',
    '/api/files/create' => __DIR__ . '/api/files/create.php',
    '/api/files/upload' => __DIR__ . '/api/files/upload.php',
    '/api/files/delete' => __DIR__ . '/api/files/delete.php',
    '/api/files/rename' => __DIR__ . '/api/files/rename.php',
    '/api/files/copy' => __DIR__ . '/api/files/copy.php',
    '/api/files/move' => __DIR__ . '/api/files/move.php',
    ...
    '/php/workspace_action' => __DIR__ . '/php/workspace_action.php',
    '/php/workspace_action.php' => __DIR__ . '/php/workspace_action.php',
    '/php/initialize_payment' => __DIR__ . '/php/initialize_payment.php',
    '/php/initialize_payment.php' => __DIR__ . '/php/initialize_payment.php',
    '/php/flutterwave_checkout' => __DIR__ . '/php/flutterwave_checkout.php',
    '/php/flutterwave_checkout.php' => __DIR__ . '/php/flutterwave_checkout.php',
...
if ($tenantRouteSubdomain === null && in_array(strtolower($currentHost), $landingHosts, true)) {
...
if ($tenantRouteSubdomain !== null || !in_array(strtolower($currentHost), $landingHosts, true)) {
    ...
    $possibleTenantFolders = $tenantRouteSubdomain !== null
        ? [$tenantRouteSubdomain]
        : [
    ...
    if ($tenantPublicDir !== null) {
        ...
        $targetPath = $tenantPublicDir . ($tenantRouteSubdomain !== null ? $tenantRoutePath : $requestUri);
        ...
        if ($realPublicDir !== false && $realTargetPath !== false && is_file($realTargetPath) && str_starts_with($realTargetPath, $realPublicDir)) {
            ...
            // Security Gate: Standard tenant websites serve static HTML/CSS/JS assets. Arbitrary PHP script execution inside tenant workspaces is restricted.
            if ($extension === 'php') {
                http_response_code(403);
                echo "403 Forbidden - Script execution in tenant hosting directory is restricted.";
                exit;
