        ...
        <table class="table table-hover mb-0 text-xs">
          ...
          <tbody>
            <?php if ($websitesCount > 0): ?>
              <?php foreach ($myWebsites as $web): $wSub = htmlspecialchars((string)($web['subdomain'] ?? '')); ?>
                <tr>
                  <td class="p-3.5 font-semibold text-gray-800"><?php echo htmlspecialchars((string)($web['name'] ?? '')); ?></td>
                  <td class="p-3.5 font-mono text-blue-600"><a href="<?php echo htmlspecialchars((string)($web['url'] ?? '')); ?>" target="_blank"><?php echo htmlspecialchars((string)($web['url'] ?? '')); ?></a></td>
                  ...
                  <td class="p-3.5 text-right">
                    ...
                    <a href="<?php echo htmlspecialchars((string)($web['url'] ?? '')); ?>" target="_blank" class="btn btn-xs btn-light border rounded-md">Visit</a>
                  </td>
                </tr>
              <?php endforeach; ?>
            <?php else: ?>
