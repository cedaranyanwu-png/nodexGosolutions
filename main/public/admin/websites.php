        ...
        <tbody class="text-gray-700">
          <?php if (count($websitesList) > 0): ?>
            <?php foreach (array_reverse($websitesList) as $wb):
              ...
              $wUrl = htmlspecialchars((string)($wb['url'] ?? ''));
            ...
            ?>
              <tr class="web-row">
                ...
                <td class="p-3.5 font-mono text-blue-600"><a href="<?php echo $wUrl; ?>" target="_blank" class="hover:underline"><?php echo $wUrl; ?></a></td>
                ...
                <td class="p-3.5 text-end">
                  <a href="<?php echo $wUrl; ?>" target="_blank" class="btn btn-xs btn-outline-primary rounded-md me-1">
