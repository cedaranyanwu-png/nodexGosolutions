...
<!-- Major control-plane hero: presentation-only, metrics below remain unchanged. -->
<section class="nx-command-hero mb-4">
  <div class="nx-command-hero-glow"></div>
  <div class="position-relative">
    <div class="section-kicker mb-2"><i class="fa-solid fa-satellite-dish me-1"></i> NodeXGo operations center</div>
    <div class="d-flex flex-column flex-lg-row justify-content-between gap-3 align-items-lg-end">
      <div>
        <h1 class="mb-2">Run the platform from one command surface.</h1>
        <p class="mb-0">Monitor tenants, hosting, revenue, support, and security from a role-aware control plane.</p>
      </div>
      <div class="d-flex gap-2 flex-wrap">
        <a class="btn btn-sm btn-outline-primary" href="/admin/users"><i class="fa-solid fa-users me-1"></i>User directory</a>
        <a class="btn btn-sm btn-primary" href="/admin/settings"><i class="fa-solid fa-sliders me-1"></i>Configure platform</a>
      </div>
    </div>
  </div>
</section>
